...
MushraPage.prototype.render = function (_parent) {
  ...
  var mapDiv = $("<div id='austriaMap' style='text-align: center; margin-top: 20px;'></div>");
  var mapImage = $("<img src='/res/spatial/map_with_states.png' alt='Austria Map' style='max-width: 100%; height: auto;'>");
