...
SpatialPage.prototype.initScenes = function() {
    ...
    for (var i = 0; i < this.pageConfig.views.length; ++i) {
        ...
        let img = new Image();
        img.src = '/res/spatial/Austria_map_with_states.png';
        ...
        canvas.onmouseleave = (function(event) {
            this.page.isDragging = false;  // Cancel drag if mouse leaves the canvas
        }).bind({ page: this, canvas: canvas });
...
SpatialPage.prototype.init = function() {
    ...
    // Initialize waveform visualizer
    this.waveformVisualizer = new WaveformVisualizer(this.pageManager.getPageVariableName(this) + ".waveformVisualizer", this.renderDivs[0], this.stimuli[0], this.pageConfig.showWaveform, this.pageConfig.enableLooping, this.filePlayer);
