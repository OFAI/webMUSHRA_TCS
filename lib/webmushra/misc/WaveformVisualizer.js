...
function WaveformVisualizer(_variableName, _parent, _stimulus, _showWaveform, _enableLooping, _mushraAudioControl, _fullWidth=false){
  ...
  if(this.enableLooping || this.fullWidth){
...
WaveformVisualizer.prototype.create = function(){
  ...
  if(this.fullWidth) {
    ...
    this.canvas.width = window.innerWidth > 1300 ? window.innerWidth * 0.6 : window.innerWidth * 0.5;
  } else {
...
WaveformVisualizer.prototype.draw = function(){
  ...
  if (selected) {
    ...
    this.context.strokeStyle = 'rgb(119, 93, 93)'; // #808080 -> rgba(128, 128, 128, 1)
