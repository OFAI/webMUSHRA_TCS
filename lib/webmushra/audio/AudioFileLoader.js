      ...
      req.onload = (function() { 
        this.loader.audioContext.decodeAudioData(this.request.response, (function(buffer) {
          if (buffer.numberOfChannels === 1) {
            ...
            const stereoBuffer = this.loader.audioContext.createBuffer(2, buffer.length, buffer.sampleRate);
            stereoBuffer.copyToChannel(monoChannel, 0); // Left channel
            stereoBuffer.copyToChannel(monoChannel, 1); // Right channel
            buffer = stereoBuffer;
          }
